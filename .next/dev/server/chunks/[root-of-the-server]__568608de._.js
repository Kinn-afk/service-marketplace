...
async function GET() {
    try {
        const [services] = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute(`
...
async function POST(request) {
    try {
        ...
        const [result] = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute('INSERT INTO services (provider_id, title, description, category, hourly_rate) VALUES (?, ?, ?, ?, ?)', [
            provider_id,
            title,
            description || '',
            category || '',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__568608de._.js.map