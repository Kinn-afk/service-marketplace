...
"[project]/service-marketplace/app/api/bookings/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const [bookings] = await __TURBOPACK__imported__module__$5b$project$5d2f$service$2d$marketplace$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute(`
...
async function POST(request) {
    try {
        ...
        const [result] = await __TURBOPACK__imported__module__$5b$project$5d2f$service$2d$marketplace$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute('INSERT INTO bookings (service_id, customer_id, booking_date, booking_time, notes) VALUES (?, ?, ?, ?, ?)', [
            service_id,
            customer_id,
            booking_date,
            booking_time,
...
async function PATCH(request) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$service$2d$marketplace$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute('UPDATE bookings SET status = ? WHERE id = ?', [
            status,
            bookingId
        ]);
        return __TURBOPACK__imported__module__$5b$project$5d2f$service$2d$marketplace$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__816fef9b._.js.map