...
"[project]/service-marketplace/app/api/users/[id]/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        // Get user profile
        const [rows] = await __TURBOPACK__imported__module__$5b$project$5d2f$service$2d$marketplace$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute('SELECT id, email, name, phone, role, profile_image, created_at FROM users WHERE id = ?', [
            userId
        ]);
        if (rows.length === 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$service$2d$marketplace$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (user.role === 'provider') {
            const [serviceRows] = await __TURBOPACK__imported__module__$5b$project$5d2f$service$2d$marketplace$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute('SELECT id, title, category, description, hourly_rate, created_at FROM services WHERE provider_id = ? ORDER BY created_at DESC', [
                userId
            ]);
        ...
        let reviews = [];
        if (user.role === 'provider') {
            const [reviewRows] = await __TURBOPACK__imported__module__$5b$project$5d2f$service$2d$marketplace$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute(`
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1f830c65._.js.map